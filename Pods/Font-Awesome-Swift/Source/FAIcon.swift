...
public extension UIButton {
    ...
    func setFAText(prefixText: String, icon: FAType?, postfixText: String, size: CGFloat?, forState state: UIControlState, iconSize: CGFloat? = nil) {
        ...
        let textAttributes = [NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): textFont!, NSAttributedStringKey.foregroundColor: textColor] as [NSAttributedStringKey : Any]
        ...
        if let iconText = icon?.text {
            ...
            let iconAttributes = [NSAttributedStringKey(NSAttributedStringKey.font.rawValue): iconFont, NSAttributedStringKey.foregroundColor: textColor] as [NSAttributedStringKey : Any]
...
public extension UIImage {
    ...
    public convenience init(icon: FAType, size: CGSize, orientation: UIImageOrientation = UIImageOrientation.down, textColor: UIColor = UIColor.black, backgroundColor: UIColor = UIColor.clear) {
        ...
        assert(font != nil, FAStruct.ErrorAnnounce)
        let attributes = [NSAttributedStringKey.font: font!, NSAttributedStringKey.backgroundColor: textColor, NSAttributedStringKey.backgroundColor: backgroundColor, NSAttributedStringKey.paragraphStyle: paragraph]
